        ...
        <nav class="navbar navbar-default title1">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><b>BRIDGETTE</b></a>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <img src="image/WhatsApp Image 2024-03-03 at 11.02.08_45138753.jpg" width=100 height=100
                                alt="CHARLES OWUSU ASARE" class="img-rounded">
                        </div>
                        <div class="col-md-5">
                            <a href="http://" CHARLES OWUSU ASARE"
                                style="color:#202020; font-family:'typo' ; font-size:18px"
                                title="Find on Facebook">CHARLES OWUSU ASARE</a>
                            <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+233544545991
                            </h4>
                            <h4 style="font-family:'typo' ">owusuasarecharless@gmail.com</h4>
                            <h4 style="font-family:'typo' ">KWAME NKRUMAH UNIVERSITY OF SCIENCE AND TECHNOLOGY
                                (K.N.U.S.T)</h4>
                        </div>
                    </div>
                    </p>
